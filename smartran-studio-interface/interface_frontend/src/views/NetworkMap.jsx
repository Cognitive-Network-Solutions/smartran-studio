...
export default function NetworkMap() {
  ...
  const drawScaleIndicator = (ctx) => {
    ...
    ctx.textAlign = "left";
    ctx.fillText(
      `${scaleBarWorldLength.toFixed(0)} m`,
      15,
  ...
  const drawSite = (siteCells) => {
    ...
    sectors.forEach((cellsAtAzimuth) => {
      ...
      const sortedCells = [...cellsAtAzimuth].sort(
  ...
  const filteredCells = cells.filter((cell) => {
    ...
    const matchesText =
      txt === "" ||
      cell.cell_name.toLowerCase().includes(txt) ||
      cell.site_name.toLowerCase().includes(txt);
    const matchesBand = bandFilter === "" || cell.band === bandFilter;
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              {(() => {
                const uniqueBands = [
                  ...new Set(cells.map((c) => c.band).filter(Boolean)),
                ].sort((a, b) => {
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              >
                <i
                  className="ri-mouse-line text-lg"
                  style={{ color: "var(--color-muted)" }}
                ></i>
              ...
              >
                <i
                  className="ri-scroll-to-bottom-line text-lg"
                  style={{ color: "var(--color-muted)" }}
                ></i>
              ...
              >
                <i
                  className="ri-cursor-line text-lg"
                  style={{ color: "var(--color-muted)" }}
                ></i>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span
                    ...
                    style={{ color: "var(--color-text)" }}
                  >
                    {selectedCell.antenna_rows}×{selectedCell.antenna_cols} (
                    {selectedCell.antenna_pattern})
                  </span>
                </div>
              </div>
            </div>
